...
public:
    ...
    inline glm::mat4 GetViewMatrix() { return glm::lookAt(Position, Position + Front, Up); } // returns the view matrix calculated using Euler Angles and the LookAt Matrix
